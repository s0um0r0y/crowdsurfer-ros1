...
"""autogenerated by genpy from pedsim_msgs/TrackedPerson.msg. Do not edit."""
import codecs
import sys
...
class TrackedPerson(genpy.Message):
  _md5sum = "28bdd0d6d6551c668e4fde8aecdf1885"
  _type = "pedsim_msgs/TrackedPerson"
...
float64 z"""
  ...
  _slot_types = ['uint64','bool','bool','uint64','duration','geometry_msgs/PoseWithCovariance','geometry_msgs/TwistWithCovariance']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_Q2BQ2i7d().pack(_x.track_id, _x.is_occluded, _x.is_matched, _x.detection_id, _x.age.secs, _x.age.nsecs, _x.pose.pose.position.x, _x.pose.pose.position.y, _x.pose.pose.position.z, _x.pose.pose.orientation.x, _x.pose.pose.orientation.y, _x.pose.pose.orientation.z, _x.pose.pose.orientation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.track_id, _x.is_occluded, _x.is_matched, _x.detection_id, _x.age.secs, _x.age.nsecs, _x.pose.pose.position.x, _x.pose.pose.position.y, _x.pose.pose.position.z, _x.pose.pose.orientation.x, _x.pose.pose.orientation.y, _x.pose.pose.orientation.z, _x.pose.pose.orientation.w,) = _get_struct_Q2BQ2i7d().unpack(str[start:end])
...
def _get_struct_6d():
    ...
    return _struct_6d
_struct_Q2BQ2i7d = None
def _get_struct_Q2BQ2i7d():
    global _struct_Q2BQ2i7d
    if _struct_Q2BQ2i7d is None:
        _struct_Q2BQ2i7d = struct.Struct("<Q2BQ2i7d")
    return _struct_Q2BQ2i7d
