...
class AgentState(genpy.Message):
  _md5sum = "b47b93bd58ccba0e6f058fd6a71a4915"
...
"""
  ...
  __slots__ = ['header','id','type','social_state','pose','twist','forces']
  _slot_types = ['std_msgs/Header','uint64','uint16','string','geometry_msgs/Pose','geometry_msgs/Twist','pedsim_msgs/AgentForce']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_34d().pack(_x.pose.position.x, _x.pose.position.y, _x.pose.position.z, _x.pose.orientation.x, _x.pose.orientation.y, _x.pose.orientation.z, _x.pose.orientation.w, _x.twist.linear.x, _x.twist.linear.y, _x.twist.linear.z, _x.twist.angular.x, _x.twist.angular.y, _x.twist.angular.z, _x.forces.desired_force.x, _x.forces.desired_force.y, _x.forces.desired_force.z, _x.forces.obstacle_force.x, _x.forces.obstacle_force.y, _x.forces.obstacle_force.z, _x.forces.social_force.x, _x.forces.social_force.y, _x.forces.social_force.z, _x.forces.group_coherence_force.x, _x.forces.group_coherence_force.y, _x.forces.group_coherence_force.z, _x.forces.group_gaze_force.x, _x.forces.group_gaze_force.y, _x.forces.group_gaze_force.z, _x.forces.group_repulsion_force.x, _x.forces.group_repulsion_force.y, _x.forces.group_repulsion_force.z, _x.forces.random_force.x, _x.forces.random_force.y, _x.forces.random_force.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pose.position.x, _x.pose.position.y, _x.pose.position.z, _x.pose.orientation.x, _x.pose.orientation.y, _x.pose.orientation.z, _x.pose.orientation.w, _x.twist.linear.x, _x.twist.linear.y, _x.twist.linear.z, _x.twist.angular.x, _x.twist.angular.y, _x.twist.angular.z, _x.forces.desired_force.x, _x.forces.desired_force.y, _x.forces.desired_force.z, _x.forces.obstacle_force.x, _x.forces.obstacle_force.y, _x.forces.obstacle_force.z, _x.forces.social_force.x, _x.forces.social_force.y, _x.forces.social_force.z, _x.forces.group_coherence_force.x, _x.forces.group_coherence_force.y, _x.forces.group_coherence_force.z, _x.forces.group_gaze_force.x, _x.forces.group_gaze_force.y, _x.forces.group_gaze_force.z, _x.forces.group_repulsion_force.x, _x.forces.group_repulsion_force.y, _x.forces.group_repulsion_force.z, _x.forces.random_force.x, _x.forces.random_force.y, _x.forces.random_force.z,) = _get_struct_34d().unpack(str[start:end])
      return self
