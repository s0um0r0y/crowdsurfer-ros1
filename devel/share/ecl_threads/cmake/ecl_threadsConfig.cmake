...
if("TRUE" STREQUAL "TRUE")
  set(ecl_threads_SOURCE_PREFIX /home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/src/turtlebot2_noetic_packages/ecl_core/ecl_threads)
  set(ecl_threads_DEVEL_PREFIX /home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/devel)
  ...
  set(ecl_threads_INSTALL_PREFIX /home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/install)
...
if(NOT "/home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/src/turtlebot2_noetic_packages/ecl_core/ecl_threads/include " STREQUAL " ")
  set(ecl_threads_INCLUDE_DIRS "")
  set(_include_dirs "/home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/src/turtlebot2_noetic_packages/ecl_core/ecl_threads/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ecl_threads' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/src/turtlebot2_noetic_packages/ecl_core/ecl_threads/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ecl_threads_NUM_DUMMY_TARGETS)
      set(ecl_threads_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ecl_threads::wrapped-linker-option${ecl_threads_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ecl_threads_NUM_DUMMY_TARGETS "${ecl_threads_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ecl_threads::wrapped-linker-option${ecl_threads_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ecl_threads_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND ecl_threads_LIBRARIES ${library})
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(ecl_threads_EXPORTED_TARGETS ${${ecl_threads_dep}_EXPORTED_TARGETS})
endforeach()
