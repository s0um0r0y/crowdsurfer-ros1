...
if("TRUE" STREQUAL "TRUE")
  set(ecl_geometry_SOURCE_PREFIX /home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/src/turtlebot2_noetic_packages/ecl_core/ecl_geometry)
  set(ecl_geometry_DEVEL_PREFIX /home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/devel)
  ...
  set(ecl_geometry_INSTALL_PREFIX /home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/install)
...
if(NOT "/home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/src/turtlebot2_noetic_packages/ecl_core/ecl_geometry/include " STREQUAL " ")
  set(ecl_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/src/turtlebot2_noetic_packages/ecl_core/ecl_geometry/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ecl_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/src/turtlebot2_noetic_packages/ecl_core/ecl_geometry/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ecl_geometry_NUM_DUMMY_TARGETS)
      set(ecl_geometry_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ecl_geometry::wrapped-linker-option${ecl_geometry_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ecl_geometry_NUM_DUMMY_TARGETS "${ecl_geometry_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ecl_geometry::wrapped-linker-option${ecl_geometry_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ecl_geometry_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND ecl_geometry_LIBRARIES ${library})
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(ecl_geometry_EXPORTED_TARGETS ${${ecl_geometry_dep}_EXPORTED_TARGETS})
endforeach()
