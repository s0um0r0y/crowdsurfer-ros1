...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_interactive_markers_SOURCE_PREFIX /home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/src/turtlebot2_noetic_packages/turtlebot_interactions/turtlebot_interactive_markers)
  set(turtlebot_interactive_markers_DEVEL_PREFIX /home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/devel)
  ...
  set(turtlebot_interactive_markers_INSTALL_PREFIX /home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_interactive_markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/src/turtlebot2_noetic_packages/turtlebot_interactions/turtlebot_interactive_markers/${idir}'.  ${_report}")
    endif()
