...
if("TRUE" STREQUAL "TRUE")
  set(spencer_social_relation_msgs_SOURCE_PREFIX /home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/src/pedsim_ros_with_gazebo/2ndparty/spencer_messages/spencer_social_relation_msgs)
  set(spencer_social_relation_msgs_DEVEL_PREFIX /home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/devel)
  ...
  set(spencer_social_relation_msgs_INSTALL_PREFIX /home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/install)
...
if(NOT "/home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'spencer_social_relation_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/src/pedsim_ros_with_gazebo/2ndparty/spencer_messages/spencer_social_relation_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(spencer_social_relation_msgs_EXPORTED_TARGETS ${${spencer_social_relation_msgs_dep}_EXPORTED_TARGETS})
endforeach()
