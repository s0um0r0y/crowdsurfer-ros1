...
(cl:defclass <TrackedPersons> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (tracks
    :reader tracks
    :initarg :tracks
    :type (cl:vector spencer_tracking_msgs-msg:TrackedPerson)
   :initform (cl:make-array 0 :element-type 'spencer_tracking_msgs-msg:TrackedPerson :initial-element (cl:make-instance 'spencer_tracking_msgs-msg:TrackedPerson))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TrackedPersons>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrackedPersons)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name spencer_tracking_msgs-msg:<TrackedPersons> is deprecated: use spencer_tracking_msgs-msg:TrackedPersons instead.")))
...
(cl:defmethod tracks-val ((m <TrackedPersons>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader spencer_tracking_msgs-msg:tracks-val is deprecated.  Use spencer_tracking_msgs-msg:tracks instead.")
  (tracks m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TrackedPersons>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'tracks)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'spencer_tracking_msgs-msg:TrackedPerson))
