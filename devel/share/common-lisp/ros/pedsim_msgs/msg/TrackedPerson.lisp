...
(cl:defmethod cl:initialize-instance :after ((m <TrackedPerson>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrackedPerson)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pedsim_msgs-msg:<TrackedPerson> is deprecated: use pedsim_msgs-msg:TrackedPerson instead.")))

(cl:ensure-generic-function 'track_id-val :lambda-list '(m))
(cl:defmethod track_id-val ((m <TrackedPerson>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pedsim_msgs-msg:track_id-val is deprecated.  Use pedsim_msgs-msg:track_id instead.")
  (track_id m))

(cl:ensure-generic-function 'is_occluded-val :lambda-list '(m))
(cl:defmethod is_occluded-val ((m <TrackedPerson>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pedsim_msgs-msg:is_occluded-val is deprecated.  Use pedsim_msgs-msg:is_occluded instead.")
  (is_occluded m))

(cl:ensure-generic-function 'is_matched-val :lambda-list '(m))
(cl:defmethod is_matched-val ((m <TrackedPerson>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pedsim_msgs-msg:is_matched-val is deprecated.  Use pedsim_msgs-msg:is_matched instead.")
  (is_matched m))

(cl:ensure-generic-function 'detection_id-val :lambda-list '(m))
(cl:defmethod detection_id-val ((m <TrackedPerson>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pedsim_msgs-msg:detection_id-val is deprecated.  Use pedsim_msgs-msg:detection_id instead.")
  (detection_id m))
