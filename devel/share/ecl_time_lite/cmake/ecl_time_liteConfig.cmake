...
if("TRUE" STREQUAL "TRUE")
  set(ecl_time_lite_SOURCE_PREFIX /home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/src/turtlebot2_noetic_packages/ecl_lite/ecl_time_lite)
  set(ecl_time_lite_DEVEL_PREFIX /home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/devel)
  ...
  set(ecl_time_lite_INSTALL_PREFIX /home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/install)
...
if(NOT "/home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/src/turtlebot2_noetic_packages/ecl_lite/ecl_time_lite/include;/home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/devel/include " STREQUAL " ")
  set(ecl_time_lite_INCLUDE_DIRS "")
  set(_include_dirs "/home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/src/turtlebot2_noetic_packages/ecl_lite/ecl_time_lite/include;/home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ecl_time_lite' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/src/turtlebot2_noetic_packages/ecl_lite/ecl_time_lite/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ecl_time_lite_NUM_DUMMY_TARGETS)
      set(ecl_time_lite_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ecl_time_lite::wrapped-linker-option${ecl_time_lite_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ecl_time_lite_NUM_DUMMY_TARGETS "${ecl_time_lite_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ecl_time_lite::wrapped-linker-option${ecl_time_lite_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ecl_time_lite_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND ecl_time_lite_LIBRARIES ${library})
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(ecl_time_lite_EXPORTED_TARGETS ${${ecl_time_lite_dep}_EXPORTED_TARGETS})
endforeach()
