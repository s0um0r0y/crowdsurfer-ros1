...
if("TRUE" STREQUAL "TRUE")
  set(pedsim_sensors_SOURCE_PREFIX /home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/src/pedsim_ros_with_gazebo/pedsim_sensors)
  set(pedsim_sensors_DEVEL_PREFIX /home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/devel)
  ...
  set(pedsim_sensors_INSTALL_PREFIX /home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/install)
...
if(NOT "/home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/src/pedsim_ros_with_gazebo/pedsim_sensors/include " STREQUAL " ")
  set(pedsim_sensors_INCLUDE_DIRS "")
  set(_include_dirs "/home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/src/pedsim_ros_with_gazebo/pedsim_sensors/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pedsim_sensors' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/soumoroy/crowdsurfer_new_implementation_ws/crowdsurfer-ros1/src/pedsim_ros_with_gazebo/pedsim_sensors/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(pedsim_sensors_EXPORTED_TARGETS ${${pedsim_sensors_dep}_EXPORTED_TARGETS})
endforeach()
