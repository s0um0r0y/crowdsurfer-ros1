...
struct SocialRelations_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::pedsim_msgs::SocialRelation_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::pedsim_msgs::SocialRelation_<ContainerAllocator> >> _elements_type;
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::pedsim_msgs::SocialRelations_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.elements.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::pedsim_msgs::SocialRelation_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.elements[i]);
    }
    if (v.elements.empty() || false)
      s << "]";
  }
