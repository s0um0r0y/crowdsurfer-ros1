...
#include "../../../../../../src/pedsim_ros_with_gazebo/pedsim_simulator/include/pedsim_simulator/element/obstacle.h"
...
void Obstacle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Obstacle::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Obstacle::positionChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Obstacle::staticMetaObject = {
    { &ScenarioElement::staticMetaObject, qt_meta_stringdata_Obstacle.data,
      qt_meta_data_Obstacle,  qt_static_metacall, nullptr, nullptr}
};
...
void *Obstacle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ped::Tobstacle"))
        return static_cast< Ped::Tobstacle*>(this);
