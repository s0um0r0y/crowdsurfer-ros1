...
from .priest_optimizer_core import PriestPlannerCore
...
class PriestPlanner:
    ...
    def optimize(
        ...
        x_elite, y_elite, c_x_elite, c_y_elite, idx_min = self.priest.compute_cem(
            ...
            c_mean,
            c_cov,
            optimization_packet.variable_cost_function_indices,
        )
    ...
    def run_optimization(
        ...
        use_eager_waypoints: bool = True,
        variable_cost_function_indices: List[Tuple[Union[None, int], float]] = [(0, 1)],
    ):
        ...
        return self.optimize(
            OptimizationPacket(
                ...
                variable_cost_function_indices=variable_cost_function_indices,
            )
        )
