'''
implements a function called bernstein_coeff_order10_new, which computes Bernstein polynomials 
...
def bernstein_coeff_order10_new(n, tmin, tmax, t_actual):
		...
		# These derivatives indicate how the curve’s position changes over time. This is essential for calculating velocity in motion planning
		P0dot = -10.0*(-t + 1)**9
		...
		# Pdot Contains the velocity components (first derivatives) scaled by 1/l to adjust for the normalized range.
		Pdot = hstack((P0dot, P1dot, P2dot, P3dot, P4dot, P5dot, P6dot, P7dot, P8dot, P9dot, P10dot ))/l

		# Pddot: Contains the acceleration components (second derivatives) scaled by 1/l^2 for proper scaling.
