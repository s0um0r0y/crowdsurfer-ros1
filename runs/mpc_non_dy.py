...
class batch_crowd_nav():
    ...
    def __init__(self, a_obs_1, b_obs_1, a_obs_2, b_obs_2, v_max, v_min, a_max, num_obs_1, num_obs_2, t_fin, num, num_batch, maxiter, maxiter_cem, weight_smoothness, weight_track, way_point_shape, v_des):
        ...
        self.P, self.Pdot, self.Pddot = bernstein_coeff_order10_arbitinterval.generate_order_10_bernstein_coefficients(10, tot_time_copy[0], tot_time_copy[-1], tot_time_copy)
        ...
        P_up, Pdot_up, Pddot_up = bernstein_coeff_order10_arbitinterval.generate_order_10_bernstein_coefficients(10, tot_time_copy_up[0], tot_time_copy_up[-1], tot_time_copy_up)
    ...
    def compute_traj_guess(self, initial_state, x_obs_trajectory, y_obs_trajectory, x_obs_trajectory_dy, y_obs_trajectory_dy, v_des, x_waypoint, y_waypoint, arc_vec, x_guess_per , y_guess_per, x_diff, y_diff):
        ...
        # subtracting the static obstacle trajectories from the guessed trajectories
        wc_alpha_temp = (x_guess_sampling-x_obs_trajectory[:,jnp.newaxis])
        ws_alpha_temp = (y_guess_sampling-y_obs_trajectory[:,jnp.newaxis])

        # subtracting the dynamic_obstacle trajectories from the guessed trajectories
        ...
        # TODO : this line her is causing an issue
        ...
        # calculate the distances between the static and dynamic obstacles
        ...
        # penalty for each trajectory for staying away from obstacles
